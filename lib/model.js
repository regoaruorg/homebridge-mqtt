...
Model.prototype.identify = function (name, manufacturer, model, serialnumber, group_name) {

  var msg = {"name": name, "manufacturer": manufacturer, "model": model, "serialnumber": serialnumber, "group_name": group_name};
